...
## Low prior prob. - disease testing
...
# Low prior probability e.g. LUC {background="#37a635"}
...
# Low power e.g. gas emissions {background="#37a635"}
...
# Bias in observation process e.g. soil carbon {background="#37a635"}
